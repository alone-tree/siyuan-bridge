...
表格可以按行列修改单元格，也可以增加或删除一行、一列。图片和普通文件可以上传到思源资源目录，本地文件夹则会作为链接插入文档。本地 Markdown 文件可以直接导入为新文档，也可以把其中内容插入到现有文档的某个位置；导入只取文本，文件内嵌图片不会自动上传。笔记本和文档也可以由 AI 创建；已有文档可以改名、移动、复制、导出或删除。
